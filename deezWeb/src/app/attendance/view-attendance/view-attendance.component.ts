...
export class ViewAttendanceComponent implements OnInit {
  ...
  calculateSalary(): void {
    ...
    this.overTime = (this.basicSalary / (businessDays * 9 * 60 )) * (this.otTime / (1000 * 60)) || 0;
    this.leavePenalty = (this.basicSalary / businessDays) * this.leave;
    this.latePenalty = (this.basicSalary / (businessDays * 9 * 60 )) * (this.lateTime / (1000 * 60));
