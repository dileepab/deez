...
export class EmployeeApi extends BaseLoopBackApi {
  ...
  /**
   * Find a related item by id for attendances.
   *
   * @param {any} id Employee id
   *
   * @param {any} fk Foreign key for attendances
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdAttendances(id: any, fk: any): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Employees/:id/attendances/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Delete a related item by id for attendances.
   *
   * @param {any} id Employee id
   *
   * @param {any} fk Foreign key for attendances
   ...
   * This method returns no data.
   */
  public destroyByIdAttendances(id: any, fk: any): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Employees/:id/attendances/:fk";
    let _routeParams: any = {
  ...
  /**
   * Update a related item by id for attendances.
   *
   * @param {any} id Employee id
   *
   * @param {any} fk Foreign key for attendances
   ...
   * </em>
   */
  public updateByIdAttendances(id: any, fk: any, data: any = {}): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Employees/:id/attendances/:fk";
    let _routeParams: any = {
  ...
  /**
   * Queries attendances of Employee.
   *
   * @param {any} id Employee id
   *
   * @param {object} filter
   ...
   * </em>
   */
  public getAttendances(id: any, filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
  ...
  /**
   * Creates a new instance in attendances of this model.
   *
   * @param {any} id Employee id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createAttendances(id: any, data: any = {}): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Employees/:id/attendances";
    let _routeParams: any = {
  ...
  /**
   * Deletes all attendances of this model.
   *
   * @param {any} id Employee id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteAttendances(id: any): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Employees/:id/attendances";
    let _routeParams: any = {
  ...
  /**
   * Counts attendances of Employee.
   *
   * @param {any} id Employee id
   *
   * @param {object} where Criteria to match model instances
  ...
  public countAttendances(id: any, where: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Employees/:id/attendances/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Statistical information for Employe registers.
   *
   ...
   * </em>
   */
  public createManyAttendances(id: any, data: any[] = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Employees/:id/attendances";
    let _routeParams: any = {
  ...
  /**
   * @ngdoc method
   * @name sdk.Employee#getCurrent
   * @methodOf sdk.Employee
   *
   * @description
   *
  ...
  public getCurrent(): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/Employees" + "/:id";
   ...
   * call to {@link sdk.Employee#login} or
   * {@link sdk.Employee#getCurrent}. Return null when there
   ...
   * call to {@link sdk.Employee#login}
   *
  ...
  /**
   * @name sdk.Employee#isAuthenticated
   *
  ...
  /**
   * @name sdk.Employee#getCurrentId
   *
