...
/**
 * Api services for the `Target` model.
 */
@Injectable()
export class TargetApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Target` object.)
   * </em>
   */
  ...
  /**
   * Statistical information for target registers.
   *
